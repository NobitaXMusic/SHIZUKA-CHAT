...
BOT_USERNAME = os.environ.get("BOT_USERNAME","SHIZUKA_CHAT_BOT") 
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","DPZ_STOREE")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","N_O_B_I_T_A_7_6")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","dpz_shyari_zone")
...
SOURCE = 'https://github.com/NobitaXMusic/SHIZUKA-CHAT'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
...
async def restart(client, m: Message):
        ...
        await accha.edit("🦋𝗡𝗢𝗪 𝗖𝗢𝗠𝗘 𝗛𝗘𝗥𝗘 👉 @N_O_B_I_T_A_7_6 , @SHIZUKA_CHAT_BOT , @DPZ_STOREE 𝗔𝗡𝗗 𝗠𝗔𝗞𝗘 𝗬𝗢𝗨𝗥 𝗚𝗜𝗥𝗟𝗙𝗥𝗜𝗡𝗗 🥀💋 𝗜𝗙 𝗬𝗢 𝗛𝗔𝗩𝗘 𝗔 𝗚𝗜𝗥𝗟𝗙𝗜𝗘𝗡𝗗  😘 𝗧𝗛𝗘𝗡 𝗬𝗢𝗨 𝗪𝗜𝗟𝗟 𝗚𝗜𝗙𝗧 🙊 𝗧𝗢 𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 @BRANDEDKING82 ❤️")
